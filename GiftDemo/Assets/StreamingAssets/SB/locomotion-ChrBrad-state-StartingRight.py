...
stateChrMarineStartingRight = stateManager.getState("ChrMarineStartingRight")
if (stateChrMarineStartingRight is None):
    stateChrMarineStartingRight = stateManager.createState1D("ChrMarineStartingRight")
    stateChrMarineStartingRight.setBlendSkeleton("ChrBrad.sk")

    motions = StringVec()
    motions.append("ChrBrad_ChrMarine@Idle01_ToWalkLf01")
    motions.append("ChrBrad_ChrMarine@Idle01_ToWalk01_Turn90Rt01")
    motions.append("ChrBrad_ChrMarine@Idle01_ToWalk01_Turn180Rt01")

    paramsX = DoubleVec()
    paramsX.append(0) # ChrBrad_ChrMarine@Idle01 X
    paramsX.append(-90) # ChrBrad_ChrMarine@Idle01_ToWalk01_Turn90Rt01 X
    paramsX.append(-180) # ChrBrad_ChrMarine@Idle01_ToWalk01_Turn180Rt01 X
