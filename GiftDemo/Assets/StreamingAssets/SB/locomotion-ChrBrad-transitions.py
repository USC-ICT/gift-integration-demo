...
walkRightTransitionIn.setEaseInInterval("ChrBrad_ChrMarine@Walk01", 1.30,1.56)
walkRightTransitionIn.addEaseOutInterval("ChrBrad_ChrMarine@Idle01_ToWalkLf01",1.34,1.56)


walkLeftTransitionIn = stateManager.createTransition("ChrMarineStartingLeft","ChrMarineLocomotion")
walkLeftTransitionIn.setEaseInInterval("ChrBrad_ChrMarine@Walk01", 0.75,1.08)
walkLeftTransitionIn.addEaseOutInterval("ChrBrad_ChrMarine@Idle01_ToWalk01",1.33,1.56)
