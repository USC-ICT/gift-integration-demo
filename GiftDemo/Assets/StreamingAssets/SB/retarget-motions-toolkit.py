...
def retargetMotionFunc(motionName, outMotionName, srcSkelName, tgtSkelName):
...
def retargetMotion(motionName, outMotionName, srcSkelName, tgtSkelName, outDir) :
	# map source skeleton and motion channels to standard names
	remapSkeleton(srcSkelName, srcSkelName)
	remapMotion(srcSkelName, motionName, srcSkelName)
	outMotionName = retargetMotionFunc(motionName, outMotionName, srcSkelName, tgtSkelName)
...
def retargetSetup(targetSkelName):
	...
	print "retargetSetup() - " + targetSkelName
	...
	scene.createSkeleton("ChrGarza.sk")
	scene.createSkeleton("ChrJustinIct.sk")
	motions = scene.getMotionNames()
	for motion in motions:
		if motion.startswith("ChrJustinIct@BackFlipAndUppercut01"):
			retargetMotion(motion, "ChrBrad_" + motion, "ChrJustinIct.sk", "ChrBrad.sk", outDir)
			retargetMotion(motion, "ChrRachel_" + motion, "ChrJustinIct.sk", "ChrRachel.sk", outDir)
			retargetMotion(motion, "ChrHarmony_" + motion, "ChrJustinIct.sk", "ChrHarmony.sk", outDir)
			retargetMotion(motion, "ChrPedro_" + motion, "ChrJustinIct.sk", "ChrPedro.sk", outDir)
			retargetMotion(motion, "ChrRio_" + motion, "ChrJustinIct.sk", "ChrRio.sk", outDir)
			retargetMotion(motion, "ChrUtah_" + motion, "ChrJustinIct.sk", "ChrUtah.sk", outDir)
			retargetMotion(motion, "soldier_" + motion, "ChrJustinIct.sk", "soldier.sk", outDir)
			retargetMotion(motion, "Alexis_" + motion,  "ChrJustinIct.sk", "Alexis.sk", outDir)
			retargetMotion(motion, "carl_" + motion,    "ChrJustinIct.sk", "carl.sk", outDir)
			retargetMotion(motion, "Joan_" + motion,    "ChrJustinIct.sk", "Joan.sk", outDir)
			retargetMotion(motion, "justin_" + motion,  "ChrJustinIct.sk", "justin.sk", outDir)
			retargetMotion(motion, "Mia_" + motion,     "ChrJustinIct.sk", "Mia.sk", outDir)
			retargetMotion(motion, "zombie_hires_" + motion, "ChrJustinIct.sk", "zombie_hires.sk", outDir)
			retargetMotion(motion, "monster_" + motion, "ChrJustinIct.sk", "monster.sk", outDir)
		if motion.startswith("ChrMiles@GangnamStyle01"):
			retargetMotion(motion, "ChrBrad_" + motion, "ChrGarza.sk", "ChrBrad.sk", outDir)
			retargetMotion(motion, "ChrRachel_" + motion, "ChrGarza.sk", "ChrRachel.sk", outDir)
			retargetMotion(motion, "ChrHarmony_" + motion, "ChrGarza.sk", "ChrHarmony.sk", outDir)
			retargetMotion(motion, "ChrPedro_" + motion, "ChrGarza.sk", "ChrPedro.sk", outDir)
			retargetMotion(motion, "ChrRio_" + motion, "ChrGarza.sk", "ChrRio.sk", outDir)
			retargetMotion(motion, "ChrUtah_" + motion, "ChrGarza.sk", "ChrUtah.sk", outDir)
			retargetMotion(motion, "ChrJustinIct_" + motion, "ChrGarza.sk", "ChrJustinIct.sk", outDir)
			retargetMotion(motion, "soldier_" + motion, "ChrGarza.sk", "soldier.sk", outDir)
			retargetMotion(motion, "Alexis_" + motion,  "ChrGarza.sk", "Alexis.sk", outDir)
			retargetMotion(motion, "carl_" + motion,    "ChrGarza.sk", "carl.sk", outDir)
			retargetMotion(motion, "Joan_" + motion,    "ChrGarza.sk", "Joan.sk", outDir)
			retargetMotion(motion, "justin_" + motion,  "ChrGarza.sk", "justin.sk", outDir)
			retargetMotion(motion, "Mia_" + motion,     "ChrGarza.sk", "Mia.sk", outDir)
			retargetMotion(motion, "zombie_hires_" + motion, "ChrGarza.sk", "zombie_hires.sk", outDir)
			retargetMotion(motion, "monster_" + motion, "ChrGarza.sk", "monster.sk", outDir)


'''
	motions = scene.getMotionNames()
	for motion in motions:
		if motion.startswith("ChrBrad@"):
			retargetMotion(motion, "ChrPedro_" + motion, "ChrBrad.sk", "ChrPedro.sk", outDir)
			retargetMotion(motion, "ChrJustinIct_" + motion,  "ChrBrad.sk", "ChrJustinIct.sk", outDir)
'''
...
'''
	...
	for motion in motions:
		if motion.startswith("ChrBrad@"):
			print "retargetSetup() - " + motion
			retargetMotion(motion, "soldier_" + motion, "ChrBrad.sk", "soldier.sk", outDir)
			retargetMotion(motion, "Alexis_" + motion,  "ChrBrad.sk", "Alexis.sk", outDir)
			retargetMotion(motion, "carl_" + motion,    "ChrBrad.sk", "carl.sk", outDir)
			retargetMotion(motion, "Joan_" + motion,    "ChrBrad.sk", "Joan.sk", outDir)
			retargetMotion(motion, "justin_" + motion,  "ChrBrad.sk", "justin.sk", outDir)
			retargetMotion(motion, "Mia_" + motion,     "ChrBrad.sk", "Mia.sk", outDir)
			retargetMotion(motion, "zombie_hires_" + motion, "ChrBrad.sk", "zombie_hires.sk", outDir)
			retargetMotion(motion, "monster_" + motion, "ChrBrad.sk", "monster.sk", outDir)
			retargetMotion(motion, "ChrRachel_" + motion, "ChrBrad.sk", "ChrRachel.sk", outDir)
		if motion.startswith("ChrUsaMleAdult@"):
			print "retargetSetup() - " + motion
			retargetMotion(motion, "ChrBrad_" + motion, "ChrUsaMleAdult.sk", "ChrBrad.sk", outDir)
		if motion.startswith("ChrMarine@"):
			print "retargetSetup() - " + motion
			retargetMotion(motion, "ChrBrad_" + motion, "ChrBackovic.sk", "ChrBrad.sk", outDir)
'''
...
print "retargetSetup()"
scene.setDoubleAttribute("scale", 1.0)
retargetSetup("")
