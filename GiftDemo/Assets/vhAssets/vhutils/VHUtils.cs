...
public static class VHUtils
{
    ...
    public static void PlayWWWSound(MonoBehaviour behaviour, WWW www, AudioSource source, bool loop, AudioType audioType)
    {
    ...
    static IEnumerator PlayWWWSoundInternal(MonoBehaviour behaviour, string url, AudioSource source, bool loop, AudioType audioType, OnAudioFinishedPlaying onFinishedPlaying)
    {
...
#else
        using (UnityEngine.Networking.UnityWebRequest request = UnityEngine.Networking.UnityWebRequest.GetAudioClip(url, audioType))
#endif
        {
