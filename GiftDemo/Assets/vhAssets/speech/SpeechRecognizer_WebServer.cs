...
public class SpeechRecognizer_WebServer : SpeechRecognizer
{
    ...
    public const string Splitter = "___MSG_SPLIT___";
    #endregion

    #region Variables
    public string m_WebServerUrl = "https://example.com/VHToolkitASP/SpeechRecognizer.aspx";
    string m_ParticipantId = Guid.NewGuid().ToString();
    public string m_User = "adam";
    public string m_Topic = "General - Medium";
    public string Asr;
    public int Flac_Compression;
    ...
    public void SetWebLogProjectData(string projectName, string sessionName, string participantId, string platform, string location)
    {
    ...
    IEnumerator UploadAudioClip(string webServerUrl, AudioClip clip)
    {
        ...
        form.AddField("Asr",Asr);
        form.AddField("Flac_Compression", Flac_Compression);
