...
/// <summary>
/// taken from Hierarchy Organizer v3.0 and hevily modified
/// By Isaiah Kelly
/// @IsaiahKelly on Twitter
/// isaiah@dangerofdeath.com
/// </summary>

public class VHSorting : EditorWindow
{
    ...
    [MenuItem("VH/Sorting/Window/Sorting")]
    public static void ShowWindow ()
    {
        // Show existing window instance or make one.
        EditorWindow.GetWindow (typeof(VHSorting));
    }
    ...
    [MenuItem ("VH/Sorting/GameObject/Move Up %[")]
    static void MoveUp ()
    {
    ...
    [MenuItem ("VH/Sorting/GameObject/Move Up %[", true)]
    ...
    [MenuItem ("VH/Sorting/GameObject/Move Down %]")]
    ...
    // Used to validate the menu item defined by the function above.
    [MenuItem ("VH/Sorting/GameObject/Move Down %]", true)]
    ...
    [MenuItem ("VH/Sorting/GameObject/Sort Children %'")]
    ...
    // Used to validate the menu item defined by the function above.
    [MenuItem ("VH/Sorting/GameObject/Sort Children %'", true)]
    ...
    [MenuItem ("VH/Sorting/Tools/Sort Hierarchy")]
