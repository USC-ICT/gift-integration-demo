...
/// <summary>
/// Used for smartbody character debugging/functionality.
/// </summary>
public class SBMWindow : EditorWindow
{
    ...
    void ToggleDebugFlag(UnitySmartbodyCharacter.DebugFlags flag)
    {
        ...
        {
            Debug.LogError("You can't toggle Smartbody debug options if SmartbodyManager is not in the scene");
        }
    }
    ...
    void PlayAnimation(string character, string animName)
    {
        ...
        {
            Debug.LogError("You can't play animations if SmartbodyManager is not in the scene");
        }
    }
